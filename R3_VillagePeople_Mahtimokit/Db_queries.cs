...
namespace R3_VillagePeople_Mahtimokit
{
    public class Db_queries
    {
        ...
        public void Get_history_orders_within_dates()
        {
            ...
            db_connection.Open();
            database_query_get_orders_in_dates.Parameters.AddWithValue("@start", main_window.dtp_History_Orders_Filter_Date_Start.Value);
            database_query_get_orders_in_dates.Parameters.AddWithValue("@end", main_window.dtp_History_Orders_Filter_Date_End.Value);
        ...
        public void Get_order_cottages_within_dates()
        {
            ...
            database_query_get_orders_in_dates.Connection = db_connection;
            db_connection.Open();
            database_query_get_orders_in_dates.Parameters.AddWithValue("@start", main_window.dtp_Order_Start_Date.Value);
            database_query_get_orders_in_dates.Parameters.AddWithValue("@end", main_window.dtp_Order_End_Date.Value);
            database_query_get_orders_in_dates.ExecuteNonQuery();
            myReader = database_query_get_orders_in_dates.ExecuteReader();
            while (myReader.Read())
            {
        ...
        {
            if (main_window.dgv_Order_Services_All.SelectedCells.Count > 0)
            {
                // Tyhjennetään nykyiset palvelut ja mökit.
                main_window.lsv_History_Order_Cottages.Clear();
                main_window.lsv_History_Order_Services.Clear();
                // Alustetaan apumuuttujat ja haetaan varaus_id.
                string varaus_id = "";
                string toimipiste_id = "";
                string asiakas_id = "";
                SqlDataReader myReader = null;
                foreach (DataGridViewRow row in main_window.dgv_History_Orders_All.SelectedRows)
                {
                    varaus_id = row.Cells[0].Value.ToString();
                }
                main_window.lbl_History_Order_varaus_id.Text = "Varausnumero: " + varaus_id;
                ...
                while (myReader.Read())
                {
                    ...
                    main_window.lbl_History_Order_Start.Text = "Alkamispäivä: " + Convert.ToDateTime(myReader["varattu_alkupvm"]).ToString("dd.MM.yyyy");
                    main_window.lbl_History_Order_End.Text = "Päättymispäivä: " + Convert.ToDateTime(myReader["varattu_loppupvm"]).ToString("dd.MM.yyyy");
                    main_window.txt_History_Order_Additional_Details.Text = (myReader["lisatieto"].ToString());
                }
                db_connection.Close();
                ...
                while (myReader.Read())
                {
                    main_window.lbl_History_Selected_Order_Office.Text = "Toimipiste: " + (myReader["nimi"].ToString());
                }
                db_connection.Close();
                ...
                while (myReader.Read())
                {
                    main_window.lbl_History_Selected_Order_Customer.Text = "Asiakas: " + (myReader["kokonimi"].ToString());
                }
                db_connection.Close();
                ...
                foreach (int cottage_id in order_cottages)
                {
                    ...
                    db_connection.Close();
                    main_window.lsv_History_Order_Cottages.Items.Add(majoitus_nimi + " [" + persons + "]");
                }
                ...
                foreach (int service_id in order_services)
                {
                    ...
                    // Suljetaan yhteys ja lisätään varauksen mökki listview näkymään.
                    db_connection.Close();
                    main_window.lsv_History_Order_Services.Items.Add(palvelun_nimi + " [" + quantity + "]");
                }
            }
        }
        ...
        public void Get_customer_names_to_grid()
        {
            using (SqlDataAdapter database_query = new SqlDataAdapter("SELECT asiakas_id, kokonimi FROM Asiakas", db_connection))
            {
                ...
                {
                    main_window.dgv_Order_Customers_All.DataSource = data_set.Tables[0].DefaultView;
                    main_window.dgv_Customers_All.DataSource = data_set.Tables[0].DefaultView;
                    main_window.dgv_History_Customers_All.DataSource = data_set.Tables[0].DefaultView;
                    ...
                    if (main_window.dgv_Order_Customers_All.Rows.OfType<DataGridViewRow>().Any())
                    {
                        main_window.dgv_Order_Customers_All.CurrentCell = main_window.dgv_Order_Customers_All[1, 0];
                        main_window.dgv_Customers_All.CurrentCell = main_window.dgv_Customers_All[1, 0];
                        main_window.dgv_History_Customers_All.CurrentCell = main_window.dgv_History_Customers_All[1, 0];
                    }
                }
            }
        }
        ...
        {
            for (int i = 0; i < main_window.cbo_Order_Office_Select.Items.Count; i++)
            {
                main_window.cbo_Order_Office_Select.Items.RemoveAt(i);
                main_window.cbo_Office_Select.Items.RemoveAt(i);
                main_window.cbo_History_Office_Select.Items.RemoveAt(i);
                main_window.cbo_Common_Settings_Default_Office.Items.RemoveAt(i);
                i--;
            }
            ...
            while (myReader.Read())
            {
                ...
                main_window.cbo_Order_Office_Select.Items.Add(item);
                main_window.cbo_Office_Select.Items.Add(item);
                main_window.cbo_History_Office_Select.Items.Add(item);
                main_window.cbo_Common_Settings_Default_Office.Items.Add(item);
            }
            db_connection.Close();
            // Tarkistetaan, onko tietokannasta haettu yhtään toimipistettä
            if (main_window.cbo_Office_Select.Items.Count == 0)
            {
            ...
            main_window.cbo_Common_Settings_Default_Office.SelectedIndex = 0;
            ...
            if (default_office == "")
            {
                ...
                Properties.Settings.Default["default_office"] = main_window.cbo_Common_Settings_Default_Office.Text.ToString();
            ...
            main_window.cbo_Order_Office_Select.SelectedIndex = main_window.cbo_Order_Office_Select.FindStringExact(default_office);
            main_window.cbo_Office_Select.SelectedIndex = main_window.cbo_Office_Select.FindStringExact(default_office);
            main_window.cbo_History_Office_Select.SelectedIndex = main_window.cbo_History_Office_Select.FindStringExact(default_office);
            main_window.cbo_Common_Settings_Default_Office.SelectedIndex = main_window.cbo_History_Office_Select.FindStringExact(default_office);
        }
        ...
        public void Get_service_names_to_grid()
        {
            using (SqlDataAdapter database_query = new SqlDataAdapter("SELECT palvelu_id, toimipiste_id, nimi, max_osallistujat FROM Palvelu", db_connection))
            {
                ...
                if (data_set.Tables.Count > 0)
                {
                    main_window.dgv_Order_Services_All.DataSource = data_set.Tables[0].DefaultView;
                    main_window.dgv_Services_All.DataSource = data_set.Tables[0].DefaultView;
                    ...
                    if (main_window.dgv_Order_Services_All.Rows.OfType<DataGridViewRow>().Any())
                    {
                        main_window.dgv_Order_Services_All.CurrentCell = main_window.dgv_Order_Services_All[2, 0];
                        main_window.dgv_Services_All.CurrentCell = main_window.dgv_Services_All[2, 0];
                    }
                }
            }
        }
        public void Get_cottage_names_to_grid()
        {
            using (SqlDataAdapter database_query = new SqlDataAdapter("SELECT majoitus_id, toimipiste_id, nimi, max_henkilot FROM Majoitus", db_connection))
            {
                ...
                if (data_set.Tables.Count > 0)
                {
                    main_window.dgv_Order_Cottages_All.DataSource = data_set.Tables[0].DefaultView;
                    main_window.dgv_Cottages_All.DataSource = data_set.Tables[0].DefaultView;
                    // Valitaan rivi, ohjelma kohtaa virheen jos riviä ei ole valittu ja painetaan: "lisää varaukseen" tai "muokkaa".
                    // majoitus_id ja toimipiste_id ovat piilotettuja sarakeita, eli nimi = 2, ensimmäinen rivi listassa = 0.
                    if (main_window.dgv_Order_Cottages_All.Rows.OfType<DataGridViewRow>().Any())
                    {
                        main_window.dgv_Order_Cottages_All.CurrentCell = main_window.dgv_Order_Cottages_All[2, 0];
                        main_window.dgv_Cottages_All.CurrentCell = main_window.dgv_Cottages_All[2, 0];
                    }
                }
            }
        }
        ...
        public void Get_order_history_to_grid()
        {
            using (SqlDataAdapter database_query = new SqlDataAdapter("SELECT varaus_id, asiakas_id, toimipiste_id, varattu_pvm FROM Varaus", db_connection))
            {
                ...
                if (data_set.Tables.Count > 0)
                {
                    main_window.dgv_History_Orders_All.DataSource = data_set.Tables[0].DefaultView;
                    main_window.dgv_History_Orders_All.Columns[0].HeaderText = "Varausnumero";
                    main_window.dgv_History_Orders_All.Columns[3].HeaderText = "Varauksen luontipäivä";
                    main_window.dgv_History_Orders_All.Columns[3].DefaultCellStyle.Format = "dd.MM.yyyy";
                    main_window.dgv_History_Orders_All.Columns[0].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
                    main_window.dgv_History_Orders_All.Columns[0].HeaderCell.Style.Alignment = DataGridViewContentAlignment.BottomCenter;
                    main_window.dgv_History_Orders_All.Columns[3].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
                    main_window.dgv_History_Orders_All.Columns[3].HeaderCell.Style.Alignment = DataGridViewContentAlignment.BottomCenter;
                    main_window.dgv_History_Orders_All.Sort(main_window.dgv_History_Orders_All.Columns[0], ListSortDirection.Descending);
                }
            }
        }
        ...
        public void Get_log_events_to_grid()
        {
            using (SqlDataAdapter database_query = new SqlDataAdapter("SELECT paivittaja, lisatieto FROM Loki", db_connection))
            {
                ...
                if (data_set.Tables.Count > 0)
                {
                    main_window.dgv_Log.DataSource = data_set.Tables[0].DefaultView;
                    main_window.dgv_Log.Columns[0].HeaderText = "Käyttäjä";
                    main_window.dgv_Log.Columns[1].HeaderText = "Selite";
                    main_window.dgv_Log.Columns[0].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
                    main_window.dgv_Log.Columns[0].HeaderCell.Style.Alignment = DataGridViewContentAlignment.BottomCenter;
                    main_window.dgv_Log.Columns[1].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
                    main_window.dgv_Log.Columns[1].HeaderCell.Style.Alignment = DataGridViewContentAlignment.BottomCenter;
                }
            }
        }
        ///
        ...
        public void Edit_customer()
        {
            ...
            frm_Customer_Popup frm = new frm_Customer_Popup(main_window);
            frm.is_customer_edited = true;
            // Haetaan valitun DataGridView kentän ID.
            foreach (DataGridViewRow row in main_window.dgv_Order_Customers_All.SelectedRows)
            {
            ...
            frm.FormClosed += new FormClosedEventHandler(main_window.Get_customer_names_to_grid_on_close_event);
        }
        ...
        public void Edit_office()
        {
            ...
            string nimi = main_window.cbo_Office_Select.Text.ToString();
            ...
            SqlDataReader myReader = null;
            myReader = database_query.ExecuteReader();
            frm.Office_id = (main_window.cbo_Office_Select.SelectedItem as Combo_box_item).Value.ToString();
            frm.Show();
            // Asetetaan formiin tiedot tietokannasta.
            while (myReader.Read())
            {
        ...
        public void Edit_cottage()
        {
            ...
            // Haetaan valitun DataGridView kentän ID.
            if (main_window.dgv_Cottages_All.SelectedRows.Count > 0)
            {
                int selectedrowindex = main_window.dgv_Cottages_All.SelectedCells[0].RowIndex;
                DataGridViewRow selectedRow = main_window.dgv_Cottages_All.Rows[selectedrowindex];
                ...
                db_connection.Close();
                frm.FormClosed += new FormClosedEventHandler(main_window.Get_cottage_names_to_grid_on_close_event);
            }
        }
        ...
        public void Edit_service()
        {
            ...
            int selectedrowindex = main_window.dgv_Services_All.SelectedCells[0].RowIndex;
            DataGridViewRow selectedRow = main_window.dgv_Services_All.Rows[selectedrowindex];
        ...
        public void Delete_office()
        {
            ...
            string office_name = main_window.cbo_Office_Select.Text.ToString();
            ...
            string toimipiste_id = (main_window.cbo_Office_Select.SelectedItem as Combo_box_item).Value.ToString();
            // Tarkistetaan onko toimipisteeseen liitetty mökkejä tai palveluita
            if (main_window.dgv_Cottages_All.Rows.OfType<DataGridViewRow>().Any() || main_window.dgv_Services_All.Rows.OfType<DataGridViewRow>().Any())
            {
            ...
            try
            {
                ...
                if (main_window.lbl_Order_Summary_Office.Text.Contains(office_name))
                {
                    main_window.lbl_Order_Summary_Office.Text = "Toimipiste:";
                }
        ...
        public void Delete_order()
        {
            ...
            Match match = find_reservation_number.Match(main_window.lbl_History_Order_varaus_id.Text);
            ...
            main_window.lbl_History_Order_Start.Text = "Alkamispäivä";
            main_window.lbl_History_Order_End.Text = "Päättymispäivä:";
            main_window.lbl_History_Selected_Order_Office.Text = "Toimipiste:";
            main_window.lbl_History_Selected_Order_Customer.Text = "Asiakas:";
            main_window.txt_History_Order_Additional_Details.Clear();
        ...
        public void Delete_cottage()
        {
            if (main_window.dgv_Cottages_All.SelectedRows.Count > 0)
            {
                ...
                foreach (ListViewItem cottage_rows in main_window.lsv_Order_Summary_Cottages.Items)
                {
        ...
        {
            if (main_window.dgv_Services_All.SelectedRows.Count > 0)
            {
                // Haetaan valitun DataGridView kentän ID.
                int selectedrowindex = main_window.dgv_Services_All.SelectedCells[0].RowIndex;
                DataGridViewRow selectedRow = main_window.dgv_Services_All.Rows[selectedrowindex];
                ...
                foreach (ListViewItem service_rows in main_window.lsv_Order_Summary_Services.Items)
                {
                    // Haetaan palvelun_id listan riviin liitetystä "Tag" arvosta.
